...
pub mod agent_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn hello(
            ...
            let path = http::uri::PathAndQuery::from_static("/agent.Agent/Hello");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("agent.Agent", "Hello"));
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/agent.Agent/Hello" => {
                    ...
                    struct HelloSvc<T: Agent>(pub Arc<T>);
                    impl<T: Agent> tonic::server::UnaryService<super::HelloRequest>
                    for HelloSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Agent>::hello(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
